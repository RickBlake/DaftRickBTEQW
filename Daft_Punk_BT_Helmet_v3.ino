...
#define NUMPIXELS      256    //Amount of LEDs. I have 7 row of 15 LEDs wit a total of 105 LEDs
...
Adafruit_NeoMatrix matrix = Adafruit_NeoMatrix(
  ...
  NEO_MATRIX_COLUMNS + NEO_MATRIX_ZIGZAG,             //Define the type of connection (in a zig zag connections and divided by rows not columns)
  NEO_GRB            + NEO_KHZ800);

String text = "HARDER BETTER FASTER STRONGER";                 //Put here the default text to be printed on the LED matrix when it's powered on
...
void loop() 
{
  ...
  if(print_side_to_side && !print_off)
  {
    ...
    // while (k < 105)
    // {
    //   matrix.setPixelColor(k, pixels.Color(0,0,0)); 
    //   k = k + 1;
    // }
    // k=0;
    ...
    // while(i < 15)
    // {
    //   matrix.setPixelColor(60-i, pixels.Color(0,0,0)); 
    //   matrix.setPixelColor(59-i, pixels.Color(255,255,255));
    ...
    // while(i >= 0)
    // {
    //   matrix.setPixelColor(58-i, pixels.Color(0,0,0));
    //   matrix.setPixelColor(59-i, pixels.Color(255,255,255)); 
    //   matrix.show(); // This sends the updated pixel color to the hardware.
    //   delay(Delay_time);
    //   i = i - 1;
  ...
  if(print_spectrum && !print_off)
  {
    ...
    if(level==1)
    {
      ...
      while (r < 105)
      {
        matrix.setPixelColor(r, pixels.Color(0,0,0)); 
        r = r + 1;
      }
      r=0;
      while (r < 15)
      {
        matrix.setPixelColor(r, pixels.Color(0,255,0)); 
        r = r + 1;
      }
      r=0;
      matrix.show(); // This sends the updated pixel color to the hardware.
    ...
    if(level==2)
    {
      ...
      while (r < 30)
      {
        matrix.setPixelColor(r, pixels.Color(150,255,0)); 
        r = r + 1;
      }
      r=0;
      matrix.show(); // This sends the updated pixel color to the hardware.
    ...
    if(level==3)
    {
      ...
      while (r < 45)
      {
        matrix.setPixelColor(r, pixels.Color(255,255,0)); 
        r = r + 1;
      }
      r=0;
      matrix.show(); // This sends the updated pixel color to the hardware.
    ...
    if(level==4)
    {
      ...
      while (r < 60)
      {
        matrix.setPixelColor(r, pixels.Color(255,150,0)); 
        r = r + 1;
      }
  ...
  if(level==5)
    {
      ...
      while (r < 75)
      {
        matrix.setPixelColor(r, pixels.Color(255,75,0)); 
        r = r + 1;
      }
  ...
  if(level==6)
    {
      ...
      while (r < 75)
      {
        matrix.setPixelColor(r, pixels.Color(255,50,0)); 
        r = r + 1;
      }
      ...
      while (r < 90)
      {
        matrix.setPixelColor(r, pixels.Color(255,25,0)); 
        r = r + 1;
      }
  ...
  if(level==7)
    {
      ...
      while (r < 105)
      {
        matrix.setPixelColor(r, pixels.Color(255,0,0)); 
        r = r + 1;
      }
